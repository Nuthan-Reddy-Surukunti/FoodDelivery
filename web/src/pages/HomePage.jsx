...
// Map CuisineType integer enum → display name + emoji
...
const cuisineEmoji = (type) =>
  CUISINE_DISPLAY[type]?.emoji || '🍽️'
...
const StarIcon = () => (
  <span className="material-symbols-outlined filled text-yellow-400" style={{ fontSize: 14, fontVariationSettings: "'FILL' 1" }}>
    star
  </span>
)
...
export const HomePage = () => {
  ...
  const [activeCuisine, setActiveCuisine] = useState(null) // null = All
  ...
  // Distinct cuisine types from fetched data
  ...
  // Split into featured + rest for bento layout
