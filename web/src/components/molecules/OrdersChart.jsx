  ...
  return (
    <div className="bg-surface-container-lowest p-6 rounded-xl border border-surface-variant shadow-sm flex flex-col">
      <div className="flex justify-between items-center mb-6">
        ...
        <span className="text-primary font-label-md text-label-md flex items-center px-3 py-1.5 rounded-lg text-sm bg-blue-50">
          Last 7 Days
        </span>
      </div>
      ...
      <div style={{ height: `${height}px` }} className="w-full">
        {data.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-slate-400 gap-2">
            ...
            <p className="text-sm">No order data for the last 7 days</p>
          </div>
        ) : (
