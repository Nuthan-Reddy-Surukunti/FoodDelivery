          ...
          <div className="flex items-center gap-2">
            ...
            {isAuthenticated ? (
              <>
                ...
                <Link
                  to="/profile"
                  className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-rose-400 text-white text-sm font-bold flex items-center justify-center shadow-sm hover:shadow-md hover:scale-105 transition-all"
                  aria-label="Profile"
                >
              ...
              <>
                ...
                <Link to="/register" className="bg-gradient-to-r from-primary to-rose-400 text-white rounded-xl px-5 py-2 text-sm font-bold hover:shadow-lg hover:shadow-primary/20 transition-all active:scale-95">
                  Sign Up
                </Link>
              </>
            )}
