        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisputeStatus = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DisputeReason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    DisputeResolutionNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeliveredAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DisputeRaisedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DisputeResolvedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageOrderValue = table.Column<double>(type: "float", nullable: false),
                    MetricsStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    MetricsEndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
