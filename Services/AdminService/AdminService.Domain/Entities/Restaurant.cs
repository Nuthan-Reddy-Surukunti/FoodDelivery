...
public class Restaurant
{
    ...
    private Restaurant(Guid ownerId, string name, string description, Address address, ContactInfo contactInfo)
    {
        Id = Guid.NewGuid();
        OwnerId = ownerId;
    ...
    public static Restaurant Create(Guid ownerId, string name, string description, Address address, ContactInfo contactInfo)
    {
        return new Restaurant(ownerId, name, description, address, contactInfo);
    }
