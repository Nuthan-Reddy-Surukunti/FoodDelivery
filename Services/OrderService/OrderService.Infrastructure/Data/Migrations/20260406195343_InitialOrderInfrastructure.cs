...
{
    /// <inheritdoc />
    public partial class InitialOrderInfrastructure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryStreet = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    DeliveryCity = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
                    DeliveryPincode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    DeliveryAddressType = table.Column<int>(type: "int", nullable: true),
                    ...
                    CheckoutStartedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomizationNotes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_UserRestaurant_Active",
                table: "Carts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_CurrentStatus",
                table: "DeliveryAssignments",
                column: "CurrentStatus");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_DeliveryAgentId",
                table: "DeliveryAssignments",
